...
<title>Employee Registration using AJAX</title>
</head>
<body>
	${successMsg}
	<div align="center">
		<h1>Employee Registration Form (using AJAX)</h1>
		<!--  onsubmit="return doAjaxPost();" -->
		<form action="insertEmployee" method="post" id="addform">
			...
			<table style="width: 50%">
				...
				<tr>
					...
					<td><input type="number" id="totalExperience"
						name="totalExperience" placeholder="Total Experience (Numeric)" /></td>
				</tr>
				<tr>
